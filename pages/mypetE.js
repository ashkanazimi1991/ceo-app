...
{/* ...............................info1............................ */}
    <div className='flex flex-row-reverse  lg:flex-col-reverse w-full justify-center items-center p-[5%] '>
        ...
        <h2 className='text-left border-b-2 py-3 border-gray-500  px-[10%]  text-[#0c80ad] text-md sm:px-[2%]'>
                Everything a veterinary clinic needs</h2>
            <p className='text-lg w-full text-left text-gray-400 py-2 px-[10%] sm:px-[2%] leading-10'>
            An integrated, fast and safe hospital with online visits and consultations, along with stores, pet shops and online pharmacies and dozens of other items, some of which we will mention below.            </p>
...
<div className='flex h-full flex-col p-[5%] sm:p-1 justify-center lg:w-full w-1/2'>
<h2 className='text-left border-b-2 py-3 border-gray-500  px-[10%]  text-[#0c80ad] text-md sm:px-[2%]'>
        Comprehensive and independent categories for each species </h2>
...
<div className='flex h-full flex-col p-[5%] sm:p-1 justify-center lg:w-full w-1/2'>
<h2 className='text-left border-b-2 py-3 border-gray-500  px-[10%]  text-[#0c80ad] text-md sm:px-[2%]'>
        A dedicated platform for voice, video call and Live chat </h2>
<p className='text-sm text-left text-gray-400 py-2 px-[10%] sm:px-[2%] leading-10'>
    To have an unlimited and independent platform, all parts such as chats and online calls are coded inside the platform and no external or ready-made modules and plugins are used.    </p>
...
<div className='flex h-full flex-col p-[5%] sm:p-1 justify-center lg:w-full w-1/2'>
<h2 className='text-left border-b-2 py-3 border-gray-500  px-[10%]  text-[#0c80ad] text-md sm:px-[2%]'>
        Stores and specialized pharmacies for any kind </h2>
    <p className='text-sm text-left text-gray-400 py-2 px-[10%] sm:px-[2%] leading-10'>
      The platform is programmed and designed in such a way that all categories and sub-categories are independent, exclusive and comprehensive, in addition, the entire platform is scalable and there is no limit in adding new categories or sections.    </p>
...
The management dashboards of the online management set make it possible to view and manage all the items of your business in one platform. These sections can be implemented in management, admin and operator layers, the capabilities of these dashboards can be used for store and pharmacy management and accounting, profit viewing, patient control sections that include patient files, visits, and payments. And... all of them are in schematic diagrams with real-time reporting capability
 </p>
...
<div className='flex justify-center w-full'>
 ...
 {/* ........................... */}
    <div>
      ...
      Dedicated platform for veterinary clinics
       </h1>
     </div>
{/* ................................. */}
