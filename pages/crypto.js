...
import SearchBar from '../components/Crypto/Coins/SearchBar/index';
    ...
    <Image
        ...
        <div className='min-h-screen flex flex-col  justify-center w-full'>
          ...
          <div className='w-1/2 sm:w-full'>
            <h1 className='text-gray-500 md:text-2xl text-4xl '>Buy, trade, and hold 350+ cryptocurrencies</h1>
            <p className='text-[#0c80ad] text-lg'>We build  exchanges platforms with React framework just like Binance</p>
            <h2 className='text-white py-5 '>Trade Bitcoin for free</h2>
              {/* ................signin........................... */}
              <div className='bg-yellow-400 rounded-md py-2 w-full'>
                <h2 className='text-center'>Sign up with Email or Phone</h2>
              </div>
              <h2 className='text-center text-white py-2'>or continue with</h2>
              ...
              <div className='flex justify-around items-center border py-2  rounded-md'>
               ...
               <div className='flex justify-around dark items-center border py-2  rounded-md'>
                <Image
                className="  w-6 object-contain "
       ...
       {/* .......................................................................... */}
          <div className='border overflow-x-scroll  bg-[#000000af] border-gray-800 rounded-t-lg mx-16 md:mx-10 sm:mx-2'>
            <h2 className='text-gray-200 py-4 text-2xl pl-4'>Popular cryptocurrencies</h2>
          ...
          {/* ............................../priceList........................... */}
            ...
            <div className='flex items-center px-[5%] md:flex-col w-full justify-around '>
              <div className='w-1/2 md:w-full'>
                <h2 className='text-[#0c80ad]  text-3xl'> Build Your Own Crypto</h2>
                <p className='text-gray-400 text-xl pr-[10%] py-6'>
                  OnlineCEO community builds Your token, Whitepaper, and web app from scratch on any blockchain you like with a verified smart contract and  Deploy it on swap platforms ready to start.
               </p>
               <Link href="/contactUs">
