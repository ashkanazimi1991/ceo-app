...
<div className='flex md:flex-col w-full px-[8%] justify-around items-center'>
    ...
    <div className='w-1/2 border-r-2 md:border-0 md:w-full'>
        <p className='text-gray-200 text-center '>دسته بندی های هزینه </p>
        <CategoriesPage/>
        <ItemList/>
    </div>
   
    <div className='w-1/2 md:w-full'>
       <p className='text-gray-200 text-center '>دسته بندی های درآمد </p>
        <CategoriesPage/>
        <ItemList/>
