...
{/* ...............................info1............................ */}
    ...
    <div className='flex flex-row-reverse  lg:flex-col-reverse w-full justify-center items-center p-[5%] '>
        ...
        text-2xl sm:px-[2%]'>
        İşletmenizi ÇEVRİMİÇİ YAPIN
        </h2>

            <p className='text-lg w-full text-left text-gray-400 py-2 px-[10%] sm:px-[2%] leading-10'>
            tüm işletmelerin satacak bir şeyleri vardır, bu nedenle ürün veya hizmet satmak için ölçeklenebilir bir platformdan daha iyi bir şey size yardımcı olamaz            </p>
            <h2 className='w-full border-b-2 text-white text-center py-4'>Platformların teknik özellikleri</h2>
            <div className="   py-5 relative ">
            <Speed />
            <h2 className='text-white text-center'>Zayıf bir ağda bile hızlı</h2>
...
Kapsamlı ve bağımsız kategoriler
 </h2>
...
Platform, tüm kategori ve alt kategorilerin bağımsız, özel ve kapsamlı olacağı şekilde programlanmış ve tasarlanmıştır, ayrıca platformun tamamı ölçeklenebilir ve yeni kategori veya bölüm ekleme sınırı yoktur.
    ...
    <h2 className='w-full border-b-2 text-white text-center py-4'>Tüm bileşenlerden canlı raporlar alın</h2>
  <ColumnCatEnglish/>
</div>
...
Çevrimiçi CEO topluluğunun yönetim panoları, işletmenizin tüm öğelerini tek bir platformda görüntülemeyi ve yönetmeyi mümkün kılar. Bu bölümler yönetim, yönetici ve operatör katmanlarında uygulanabilir.
</p>
...
<div className='flex justify-center w-full'>
 ...
 {/* ........................... */}
    <div className=''>
        <h2 className='px-[10%] text-center text-xl text-[#2c9097]'>Tüm İşletmelerin satacak bir şeyleri vardır</h2>
