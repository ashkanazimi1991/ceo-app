      ...
      <div className=' w-full  flex flex-col justify-center h-screen '>
              ...
              <div className='flex flex-col justify-center  h-full   '>
                 ...
                 text-center'>ONLINE CEO <br></br> Developers Community</h1>
                      ...
                      <p className='text-[#999999] leading-10 text-center text-xl md:text-lg py-4 sm:pt-5 px-[5%] '>
                      Build powerful platforms for your own startup, business or portfolio by CEO Developers.    
                      </p>
                  </div>
                  ...
                  <div className='flex  justify-center w-full'>
                    ...
                    <Link href="/gallery" >
                    <h3 className='text-[#4ca8cc]  shadow-xl bg-[#00000044] text-center  animate-pulse rounded-lg  px-5 py-2'>
                          Explore in Project
                          </h3>
                    </Link>
                  </div>
