...
export default function DashChartSectionE() {
  return (
    <div className="flex flex-col   bg-[#0000005b] h-full w-full min-h-[400px] sm:min-w-[220px] min-w-[400px]">
       <h1 className="text-center text-white py-4 bg-[#0f1a20f6] border-y-2">Example of dashboard features</h1>
        ...
        <div className="flex justify-around py-2">
            <h2 className="text-white"> Today: 25 people</h2>
            <h2 className="text-white">  User: Ashkan Azimi</h2>
        </div>
        <div className="flex flex-row sm:flex-col">
           ...
           <div className="w-1/4 sm:w-full">
              <Performance/>
             <h2 className="text-white text-center text-sm">Today's to Do</h2>
